...
var API_URL = 'https://www.colr.org/json/colors/random/';
var currentColorHex = '';
var currentDifficulty = 2;
var score = 0;
var fetchColors = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, _yield$response$json, colors;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch("".concat(API_URL).concat(currentDifficulty));
        case 3:
        ...
        case 6:
          ...
          colors = _yield$response$json.colors;
          return _context.abrupt("return", colors.map(function (color) {
            return "#".concat(color.hex);
          }));
        case 11:
          _context.prev = 11;
...
var startNewGame = function startNewGame() {
  fetchColors().then(function (colors) {
...
var displayQuestion = function displayQuestion() {
  var colorHexElement = document.getElementById('colorHex');
  colorHexElement.textContent = currentColorHex;
  colorHexElement.style.color = currentColorHex;
};
var displayAnswers = function displayAnswers(colors) {
  ...
  try {
    var _loop = function _loop() {
      ...
      answerElement.onclick = function () {
        return handleAnswerClick(color);
      };
...
var handleAnswerClick = function handleAnswerClick(color) {
  color === currentColorHex ? handleCorrectAnswer() : handleIncorrectAnswer();
};
var handleCorrectAnswer = function handleCorrectAnswer() {
  document.body.style.backgroundColor = currentColorHex;
  displayResultMessage('Brawo! Poprawna odpowiedź.');
  updateScore(1);
  startNewGame();
};
var handleIncorrectAnswer = function handleIncorrectAnswer() {
  displayResultMessage('Niestety, to nie ten kolor.');
  startNewGame();
};
var displayResultMessage = function displayResultMessage(message) {
  var oldMessageElement = document.getElementById('resultMessage');
  if (oldMessageElement) {
    oldMessageElement.remove();
  }
  var resultMessageElement = document.createElement('p');
...
var updateScore = function updateScore(points) {
  score += points;
  displayScore();
...
var initializeScore = function initializeScore() {
  var storedScore = sessionStorage.getItem('score');
  score = storedScore ? parseInt(storedScore) : score;
};
var generateDifficultyLevels = function generateDifficultyLevels() {
  var difficultyLevelsElement = document.getElementById('difficultyLevels');
  var _loop2 = function _loop2(i) {
    var difficultyLevelElement = document.createElement('div');
    difficultyLevelElement.className = 'difficultyLevel';
    difficultyLevelElement.textContent = i;
    difficultyLevelElement.onclick = function () {
      currentDifficulty = i;
      startNewGame();
    };
...
},{}]},{},["../../../Users/Admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.js"], null)
